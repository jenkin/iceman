...
describe('Markdown', () => {
  describe('parse()', () => {
    ...
    it('Should produce classic link with custom onclick with state reference', () => {
      expect(Markdown.parse('[[dest][s.onclick=1]]')).toBe('<tw-link role="link" onclick="window.Story.store.onclick=1" data-passage="dest">dest</tw-link>');
    });
    ...
    it('Should produce bar link with custom onclick with state reference', () => {
      expect(Markdown.parse('[[rename|dest][s.onclick=1]]')).toBe('<tw-link role="link" onclick="window.Story.store.onclick=1" data-passage="dest">rename</tw-link>');
    });
    ...
    it('Should produce left arrow link with custom onclick with state reference', () => {
      expect(Markdown.parse('[[dest<-rename][s.onclick=1]]')).toBe('<tw-link role="link" onclick="window.Story.store.onclick=1" data-passage="dest">rename</tw-link>');
    });
  });
